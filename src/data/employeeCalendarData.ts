...
export const INITIAL_EMPLOYEE_REMINDERS: EmployeeDailyReminder[] = [
  ...
  },
  {
    ...
    description: 'Upload renewed certification certificate to Workqora profile.',
    category: 'compliance',
    priority: 'high',
    isCompleted: false,
    notifyApp: true,
  ...
  },
  {
    ...
    description: 'Workqora guest review top-mention bonus announcements.',
...
export const INITIAL_EMPLOYEE_GOALS: EmployeeGoal[] = [
  ...
  },
  {
    ...
    description: 'Consistently deliver warm, attentive service on dinner rushes to maximize personal tip income and Workqora customer kudos.',
