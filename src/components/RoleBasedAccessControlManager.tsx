...
const AVAILABLE_TABS: { id: ActiveTab; label: string; icon: React.ComponentType<{ className?: string }>; description: string }[] = [
  ...
  { id: 'payroll', label: 'Workqora Payroll', icon: DollarSign, description: 'Tip Pooling, Overtime Tracking & Gross Pay Run' },
  { id: 'learn', label: 'Workqora Learn (LMS)', icon: GraduationCap, description: 'ServSafe, RBS Alcohol, OSHA & Upskilling Academy' },
